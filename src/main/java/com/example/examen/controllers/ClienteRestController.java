...
import com.example.examen.models.service.IClienteService;
...
public class ClienteRestController {
	...
	public Cliente update(@RequestBody Cliente cliente, @PathVariable Long id) {
		...
		currentClient.setNombres(cliente.getNombres());
		currentClient.setApellidos(cliente.getApellidos());
		currentClient.setNro_documento(cliente.getNro_documento());
